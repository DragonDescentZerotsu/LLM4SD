...
def _compute_pka_summary(mol) -> dict[str, float]:
    ...
    result = {
        "most_basic_pka": PHYSIOLOGICAL_PH,
        "most_acidic_pka": PHYSIOLOGICAL_PH,
        "num_basic_sites": 0.0,
    ...
    most_basic_pka = max(base_sites.values()) if base_sites else PHYSIOLOGICAL_PH
    most_acidic_pka = min(acid_sites.values()) if acid_sites else PHYSIOLOGICAL_PH
