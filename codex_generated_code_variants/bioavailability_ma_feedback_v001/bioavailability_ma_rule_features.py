...
def _compute_pka_summary(mol, logp: float) -> dict[str, float]:
    ...
    most_basic_pka_present = float(bool(base_sites))
    most_acidic_pka_present = float(bool(acid_sites))
    ...
    result.update(
        {
            ...
            "most_basic_pka_present": most_basic_pka_present,
            "most_acidic_pka": _as_float(most_acidic_pka),
            "most_acidic_pka_present": most_acidic_pka_present,
