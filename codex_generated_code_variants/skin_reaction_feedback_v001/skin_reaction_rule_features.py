...
def _feature_specs() -> list[tuple[str, str]]:
    return [
        ...
        ("chiral_center_count", "Count of assigned tetrahedral stereocenters."),
    ...
    features.update(
        {
            ...
            "chiral_center_count": _as_float(
                len(rdkit.Chem.FindMolChiralCenters(mol, includeUnassigned=False, useLegacyImplementation=False))
            ),
