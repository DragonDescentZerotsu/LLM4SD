...
def _compute_pka_summary(mol, logp: float) -> dict[str, float]:
    ...
    result["most_basic_pka"] = _as_float(most_basic_pka) if base_sites else math.nan
    result["most_acidic_pka"] = _as_float(most_acidic_pka) if acid_sites else math.nan
