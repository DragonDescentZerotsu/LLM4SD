...
def _feature_specs() -> list[tuple[str, str]]:
    return [
        ...
        ("aromatic_alert_family_count", "Count of aromatic or polycyclic Ames alert families matched."),
        ("reactive_alert_family_count", "Count of reactive Ames alert families matched."),
        ("ames_alert_family_count", "Count of distinct DeepResearch Ames structural alert families matched."),
        ("ames_structural_alert_present", "1 if any DeepResearch Ames structural alert is present."),
    ]
